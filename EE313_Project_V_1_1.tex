...
\setlength{\unitlength}{\textwidth}
\center 
\includegraphics[width=0.45\unitlength]{mixer_v2.png}
...
\setlength{\unitlength}{\textwidth}
\center 
\includegraphics[width=0.45\unitlength]{mixer_vo.png}
...
\setlength{\unitlength}{\textwidth}
\center 
\includegraphics[width=0.45\unitlength]{mixer_fft.png}
...
\-\\
	...
	Doing some KCL at the circuit at S-Domain and setting the expressions in order, the gain and cut-off frequency can be found to be;
	
	$$ A_V = ~1~+ \frac{R_A}{R_B} $$

	$$	f_c ~=~ \frac{1}{2\pi RC}	$$
	
	Assuming capacitance value for desired frequency, resistance values can be determined. 
