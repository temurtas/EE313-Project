...
\center 
\includegraphics[width=0.5\unitlength]{mic.png}
...
\begin{equation}
f_{c} =\frac{1}{2\pi R_{42}C_{10}} 
\end{equation}
If we take $R_{42}=10k\Omega$ and $C_{10}=0.1\mu F$, cutoff frequency $f_c$ can be found as
\begin{equation}
f_{c} =\frac{1}{2\pi 10k\Omega 0.1\mu F}\approx 159 Hz
\end{equation}
